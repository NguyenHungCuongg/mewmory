...
export function MewmoryLogo({ className = "w-6 h-6" }) {
  return (
    <svg className={className} viewBox="0 0 32 32" fill="none">
      <rect width="32" height="32" rx="8" fill="#3B82F6" />
      <path d="M8 12L12 8L16 13L20 8L24 12V22C24 23.1046 23.1046 24 22 24H10C8.89543 24 8 23.1046 8 22V12Z" fill="white" />
      <circle cx="12" cy="17" r="1.5" fill="#1E40AF" />
      <circle cx="20" cy="17" r="1.5" fill="#1E40AF" />
      <path d="M15 19.5C15.5 20.2 16.5 20.2 17 19.5" stroke="#1E40AF" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
}
