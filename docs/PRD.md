...
- Khi user nhập từ đã có trong sổ, app kiểm tra:
  - Nếu trùng từ **và** trùng nghĩa đã lưu → hiển thị cảnh báo: *"Bạn đã lưu từ này với nghĩa tương tự!"*
...
| ID | Yêu cầu | Mô tả |
|---|---|---|
| NFR-01 | **Performance** | Thời gian load app < 3 giây. Lookup từ vựng < 5 giây. |
| NFR-02 | **Offline** | App phải hoạt động đầy đủ CRUD khi không có mạng. |
